...
#ifndef __AI_NETWORK_MULTITEST_H__
#define __AI_NETWORK_MULTITEST_H__
#pragma once

#include "ai_platform.h"

#define AI_NETWORK_MULTITEST_MODEL_NAME          "network_multitest"

#define AI_NETWORK_MULTITEST_IN_NUM       (1)
#define AI_NETWORK_MULTITEST_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 30, 30, 1, 1, NULL), \
}
#define AI_NETWORK_MULTITEST_IN_SIZE { \
  (30 * 30 * 1), \
}
#define AI_NETWORK_MULTITEST_IN_1_SIZE  (30 * 30 * 1)
#define AI_NETWORK_MULTITEST_IN_1_SIZE_BYTES  ((30 * 30 * 1) * 4)


#define AI_NETWORK_MULTITEST_OUT_NUM      (1)
#define AI_NETWORK_MULTITEST_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 2, 1, NULL), \
}
#define AI_NETWORK_MULTITEST_OUT_SIZE { \
  (1 * 1 * 2), \
}
#define AI_NETWORK_MULTITEST_OUT_1_SIZE  (1 * 1 * 2)
#define AI_NETWORK_MULTITEST_OUT_1_SIZE_BYTES  ((1 * 1 * 2) * 4)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup network_multitest
 ...
 * @ref ai_network_multitest_create. Both the activations memory buffer 
 ...
 * using @ref ai_network_multitest_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_NETWORK_MULTITEST_*
 * defines into file @ref network_multitest.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_network_multitest_forward(
  ai_handle network, const ai_buffer* input);


AI_API_DECLARE_END

#endif /*__AI_NETWORK_MULTITEST_H__*/
